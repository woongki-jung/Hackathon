...
Sprint 1, 2, 3, 4가 구현 완료 상태이며, Sprint 5 계획 수립 완료 상태이다.

**Why:** 10 Sprint / 5 Phase 구성이며 Phase 1, 2 완료, Phase 3 진행 예정이다.

**How to apply:** 다음 스프린트 계획 시 Sprint 6으로 번호를 설정한다.
...
| Sprint 5 | 계획 완료 / 구현 예정 | 메일 수신 + 파일 저장 + 스케줄러 | docs/sprint/sprint5.md |
